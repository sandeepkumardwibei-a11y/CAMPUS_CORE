...
// An interactive glass card: gently tilts toward the cursor in 3D and carries a soft
// light that follows the pointer underneath it — used for the "signature" moments
// (the login card, the landing quote) rather than every card, so it stays special.
export function TiltCard({ children, className = '', style, maxTilt = 7, glowColor = '16,185,129' }) {
    ...
    >
      <div
        ...
        style={{
          ...
          background: `radial-gradient(420px circle at ${glow.x}% ${glow.y}%, rgba(${glowColor},0.16), transparent 45%)`,
        }}
      />
      {children}
    </div>
